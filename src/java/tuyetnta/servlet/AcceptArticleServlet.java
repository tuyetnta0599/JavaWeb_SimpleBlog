 ...
 * @author tuyet
 */
@WebServlet(name = "AcceptArticleServlet", urlPatterns = {"/AcceptArticleServlet"})
public class AcceptArticleServlet extends HttpServlet {

    private static final Logger LOGGER = Logger.getLogger(AcceptArticleServlet.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ArticleDTO art = dao.updateStatus(id, "active", "new");
            if (art == null) {
                request.setAttribute("MSG_ERROR", "ID not exits or activated");
                return;
            } else {
                request.setAttribute("MSG_SUCCESS", "Accepted article : " + art.getTitle() + " successfull");
            }
